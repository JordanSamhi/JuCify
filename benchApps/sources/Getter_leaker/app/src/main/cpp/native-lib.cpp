...
Java_lu_uni_trux_getter_1leaker_MainActivity_nativeGetImei(JNIEnv *env, jobject thiz, jobject manager) {
...
Java_lu_uni_trux_getter_1leaker_MainActivity_nativeLeaker(JNIEnv *env, jobject thiz, jstring s) {
