...
public class SetClassFieldEvent extends SetFieldEvent {
	
	public SetClassFieldEvent(Base obj_ptr, String classname, String field_name, Base new_value) {
		super(obj_ptr, classname, field_name, new_value);
	}

	public Unit generateCode(Body b, Unit u) {		
		Pair<Value, Unit> p = AstUtils.generateValueFromAst(new_value, b, u);
